...
install_flow_coder_cli() {
    ...
    if ! get_user_confirmation "This script will install and configure pyenv, Python $PYTHON_VERSION, pipx, and Coder CLI version $FLOW_CODER_VERSION. Continue?"; then
