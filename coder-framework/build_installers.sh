...
cp coder-framework/install_coder_linux.sh coder-framework/build/linux/coder/usr/local/bin/install_coder.sh
...
cp coder-framework/install_coder_windows.bat coder-framework/build/windows/install_coder.bat
